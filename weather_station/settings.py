...
#S3Connection(os.environ['SETTINGS_KEY'])
SECRET_KEY = os.environ.get('SETTINGSKEY') # S3Connection(os.environ['SETTINGS_KEY'])
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dedg8mv52hhb6k',  # was weather_station
        'USER': 'ktumrtvhijrwwv',  # was postgres
